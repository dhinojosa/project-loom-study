...
public class E9_StructuredConcurrencyWithCancellation {
    ...
    public static void main(String[] args) {
        ...
        try (ExecutorService e =
            ...
            e.submit(E9_StructuredConcurrencyWithCancellation::task1);
            e.submit(E9_StructuredConcurrencyWithCancellation::task2);
        }
